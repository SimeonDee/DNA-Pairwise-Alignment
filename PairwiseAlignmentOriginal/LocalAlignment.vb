...
Public Class LocalAlignment
    ...
    Public Sub TracebackStep(Matrix As Cell(,), sq1 As String, sq2 As String, Seq1 As List(Of Char), Seq2 As List(Of Char))
        ...
        MessageBox.Show("MAX CELL DETAILS:" & vbCrLf & vbCrLf & "Cell Location:   row " & (CurrentCell.Row + 1).ToString & _
                        ", column " & (CurrentCell.Column + 1).ToString & vbCrLf & _
                        "Cell Value:       " + CurrentCell.CellScore.ToString, "CELL WITH MAXIMUM VALUE")
